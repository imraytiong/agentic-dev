...
*   **The AI CLI Guardrail:** Ensure the AI does *not* write Docker-Desktop specific features (like proprietary bind mounts) into the `docker-compose.yml`. The `adk-infra-builder` skill is already programmed to prevent this.