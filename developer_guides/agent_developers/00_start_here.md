...
### 1. The Theory
*   **[Conceptual Guide](conceptual_guide.md)**: Read this first. It explains the paradigm shift from traditional software to autonomous agents in simple, non-jargon terms. It covers what you are responsible for vs. what the platform handles for you.
