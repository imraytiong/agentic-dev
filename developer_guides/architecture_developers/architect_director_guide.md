...
3. The CLI will initialize and ask for the spec. Copy the contents of **[Universal Core Architecture Spec](../../specs/universal_core_architecture_spec.md)** (from the `specs` folder) and paste it into the prompt.
