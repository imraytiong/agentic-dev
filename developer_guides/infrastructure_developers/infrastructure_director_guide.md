...
3.  **The Hello World Test:** Deploy **[Hello Chassis Reference Agent](../../agent_projects/hello_chassis_reference_agent.md)** (Sparky) into your network with `mock_infrastructure=False` and verify the telemetry traces appear in Arize Phoenix.
