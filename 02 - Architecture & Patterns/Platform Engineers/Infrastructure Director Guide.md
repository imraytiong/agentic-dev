...
2. Type: `load adk-infra-builder` (view the skill instructions here: **[adk-infra-builder](../../07%20-%20AI%20CLI%20Skills/adk-infra-builder.md)**)
3. Provide the AI with the **[Fleet Infrastructure Spec](../../05%20-%20Templates/Fleet%20Infrastructure%20Spec.md)** (found in your `05 - Templates` folder).
...
3.  **The Hello World Test:** Deploy **[Hello Chassis Reference Agent](../../01%20-%20Agent%20Projects/Hello%20Chassis%20Reference%20Agent.md)** (Sparky) into your network with `mock_infrastructure=False` and verify the telemetry traces appear in Arize Phoenix.
...
*   **The AI CLI Guardrail:** Ensure the AI does *not* write Docker-Desktop specific features (like proprietary bind mounts) into the `docker-compose.yml`. The **[adk-infra-builder](../../07%20-%20AI%20CLI%20Skills/adk-infra-builder.md)** skill is already programmed to prevent this.