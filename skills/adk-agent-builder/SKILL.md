...
## 2. GIT WORKFLOW ENFORCEMENT (CRITICAL)
Before you write any code or begin planning, you MUST enforce the following Git safety net:
...
## 3. Interactive Brain Dump & MAS Threshold Diagnostics
...
## 7. Architectural Guardrails (Strict Rules)
...
## 8. Final Verification (Hallucination Check)
