...
- **Decision:** Documented in `[Agent Lifecycle Management](../03%20-%20Architecture%20&%20Patterns/Platform%20Engineers/Agent%20Lifecycle%20Management.md)`. We will rely on FastAPI lifespan hooks for initialization/shutdown and ADK's native `/health` endpoints for probes.
...
- **See full breakdown:** [Agent Fleet Deployment Infrastructure](../03%20-%20Architecture%20&%20Patterns/Platform%20Engineers/Agent%20Fleet%20Deployment%20Infrastructure.md)
