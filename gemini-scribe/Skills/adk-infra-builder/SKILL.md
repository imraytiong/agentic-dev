...
description: Guides AI coding assistants to build Operational Adapters and Deployment Manifests for the BaseAgentChassis. Enforces Hexagonal Architecture, OCI compliance, and the Bootstrap Protocol.
---
