...
description: Guides AI coding assistants to strictly adhere to the BaseAgentChassis microservice architecture. Enforces layer-by-layer generation, Safe Defaults Protocol, MAS Threshold diagnostics, and Interactive Spec Generation.
---
