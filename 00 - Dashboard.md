...
- **[[02 - Agent Projects/]]** - Active and planned AI agents. Each agent should have its own specification and architecture notes.
...
## 🚀 Active Projects
*(Link your active agent specs here when we start building)*
