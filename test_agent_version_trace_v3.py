...
async def main():
    print("\n==========================================================================")
    print("🚀  JETPACKWIZ AGENT - VERSION HISTORY TRACE TEST V3 🚀")
    print("==========================================================================\n")
    ...
    context = AgentContext(user_id="trace_user_version_3", session_id="trace_session_version_3", tenant_id="local_dev")
